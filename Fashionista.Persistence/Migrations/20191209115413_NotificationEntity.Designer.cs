...
namespace Fashionista.Persistence.Migrations
{
    ...
    [Migration("20191209115413_NotificationEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fashionista.Domain.Notification", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Fashionista.Domain.Notification", b =>
                {
                    b.HasOne("Fashionista.Domain.Entities.ApplicationUser", "Player")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId");
                });
