    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteProducts", x => new { x.ProductId, x.ApplicationUserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryFee = table.Column<decimal>(nullable: true),
                    Recipient = table.Column<string>(nullable: false),
                    RecipientPhoneNumber = table.Column<string>(nullable: false),
