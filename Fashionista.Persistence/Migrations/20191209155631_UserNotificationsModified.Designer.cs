...
namespace Fashionista.Persistence.Migrations
{
    ...
    [Migration("20191209155631_UserNotificationsModified")]
    partial class UserNotificationsModified
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fashionista.Domain.Entities.Notification", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Fashionista.Domain.Entities.Notification", b =>
                {
                    b.HasOne("Fashionista.Domain.Entities.ApplicationUser", "User")
            ...
            modelBuilder.Entity("Fashionista.Domain.Entities.ShoppingCartProduct", b =>
                {
                    b.HasOne("Fashionista.Domain.Entities.ProductColor", "Color")
                        .WithMany()
                    ...
                    b.HasOne("Fashionista.Domain.Entities.ProductSize", "Size")
                        .WithMany()
